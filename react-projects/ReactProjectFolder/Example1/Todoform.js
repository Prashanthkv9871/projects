...
const Todoform = ()=>{
    ...
    const Validate = (values)=>{
        ...
        }else if((values.number.charAt(0)==0)){
            error.number='Should not start with 0,1,2,3'
        }
                    ...
                    <form method='post' onSubmit={submitHandler}>
                        ...
                        <div className='mb-3 d-md-flex '>
                            ...
                            <div className='w-50 ms-1'>
                                <input type='text' placeholder='Enter A Valid Mobile Number' name='number' className='form-control rounded-0 py-2 fs-5'
                                value={Inputvalues.number} maxLength={10}
                                onChange={changeHandler}/>
